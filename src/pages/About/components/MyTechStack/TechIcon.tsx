...
const TechIcon = ({ tech }: { tech: Technology }) => {
  ...
  return (
    <div
      className="border-2 border-muted-foreground p-3 w-30 relative overflow-hidden transition-colors duration-500 ease-in-out"
    ...
    >
      <div
        className="flex absolute top-full right-full w-full h-full justify-center items-center  transition-all ease-in-out duration-300 "
        style={
          hover
